...
export default function AllCards(props: CollectionProps) {
  ...
  const injectStringAsHtml = (stringToHtml: string) => {
    return parse(stringToHtml).structuredText;
  };

  const goToSpecificCard = (cardDefId: string, cardInfo: object) => {
    return router.push(
      {
        pathname: `/MyAccount/AllCards/${cardDefId}`,
        query: {
          cardInfo: JSON.stringify(cardInfo),
        },
      },
      `/MyAccount/AllCards/${cardDefId}`
    );
  };
  ...
  return (
    <section className="flex gap-2  max-h-screen relative">
      ...
      >
        ...
        >
          {/* order by */}
          <div className="w-full row-span-2 col-start-1 col-span-6">
            Order by
            <div className=" flex justify-evenly text-xs flex-wrap">
              <button
          ...
          {/* card name */}
          <div className="row-span-2 col-start-7 col-span-6">
            <input
          ...
          <div className="w-full row-span-2 col-span-12 col-start-1">
            Pool
            <div className=" flex justify-evenly flex-warp text-xs flex-wrap gap-2">
              <button
                onClick={(e) => updatePoolState(e.currentTarget.id)}
                /* onClick={(e) => filteringCollectionShown(e.currentTarget.id)} */
                id="Starter Card"
          ...
          <div className="w-full row-span-2  col-span-12 col-start-1">
            Abilities
            <ul className="flex justify-evenly text-xs items-center flex-wrap gap-2">
              <li>
                <button
            ...
            return (
              ...
              >
                <Image
                  ...
                  width={120}
                  height={0}
                  onClick={(e) => goToSpecificCard(e.currentTarget.id, card)}
                  className={`${
